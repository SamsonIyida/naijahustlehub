...
export default function Home() {
  ...
  <p className="text-center text-gray-600 mb-12 leading-relaxed text-[16px] md:text-[18px]">
    At Naija Hustle Plug, your privacy is important to us.
  ...
  <div className="space-y-8 text-[16px] md:text-[17px] leading-relaxed text-gray-700">
    <div>
      <h2 className="text-xl font-semibold text-[#008753] mb-2">Information We Collect</h2>
      <p>
        We may collect personal information such as your name,
         email address, and messages when you contact us or subscribe to updates
         . We also collect anonymous data like browser type, pages visited, and time 
         spent on the site for analytics purposes.
      </p>
    </div>

    <div>
      <h2 className="text-xl font-semibold text-[#008753] mb-2">How We Use Your Information</h2>
      <p>
        Your information helps us:
      </p>
      <ul className="list-disc pl-5 mt-2 space-y-1">
        <li>Improve the content and user experience on our website</li>
        <li>Respond to your questions or feedback</li>
        <li>Send occasional updates or relevant content (only if you opt-in)</li>
      </ul>
    </div>

    <div>
      <h2 className="text-xl font-semibold text-[#008753] mb-2">Data Security</h2>
      <p>
        We take appropriate steps to protect your data and ensure it is not lost, 
        misused, or accessed without permission. However, no online platform is 100% 
        secure, so we encourage you to use strong passwords and remain cautious online.
      </p>
    </div>

    <div>
      <h2 className="text-xl font-semibold text-[#008753] mb-2">Third-Party Links</h2>
      <p>
        Our website may contain links to other websites or tools
         (e.g., affiliate links or trusted platforms). We are not responsible for the privacy
          practices of those sites. Please review their policies before submitting any data.
      </p>
    </div>

    <div>
      <h2 className="text-xl font-semibold text-[#008753] mb-2">Your Consent</h2>
      <p>
        By using Naija Hustle Plug, you agree to this privacy policy and our terms of use.
      </p>
    </div>

    <div>
      <h2 className="text-xl font-semibold text-[#008753] mb-2">Policy Updates</h2>
      <p>
        We may update this policy as needed. Any changes will be reflected

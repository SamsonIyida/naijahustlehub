...
export default function Home() {
  ...
  <p className="text-center text-gray-600 mb-12 leading-relaxed text-[16px] md:text-[18px]">
   <strong> By using Naija Hustle Plug, you agree to follow these simple terms.
     Please read them before exploring our content or taking any action. </strong>
  </p>

  <div className="space-y-6 text-[16px] md:text-[17px] leading-relaxed text-gray-700">
   <p>
  • You’re free to read, learn from, a
  nd share any hustle or content on this site with others.
   Just don’t copy and paste the full content elsewhere or
    claim it as your own. Always give credit or link back when sharing.
</p>

    
    <p>
      • We do our best to keep information accurate and up to date, but 
      we can’t guarantee perfection. Use any hustle or resource you find here at your own judgment.
    </p>

    <p>
      • Some links may be affiliate or sponsored. 
      If you click and take action, we may earn a small commission 
      at no extra cost to you.
    </p>

    <p>
      • Please don’t misuse the site. No spamming, hacking,
       or illegal activity. We have the right to block users who break the rules.
    </p>

    <p>
      • We may link to other helpful websites or tools, but
       we’re not responsible for their content or policies. 
      
    </p>

    <p>
      • We may update these terms over time. Changes will be posted here, 
      and by continuing to use the site, you agree to the latest version.
    </p>

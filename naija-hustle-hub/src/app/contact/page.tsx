...
<section className="max-w-4xl mx-auto mt-24 px-4">
  <h1 className="text-3xl font-bold text-center text-[#008753] mb-8">
    Get in touch
  </h1>

  <p className="text-center text-gray-600 mb-10">
    We’d love to hear from you. Whether you have a question, suggestion, 
    or business inquiry, feel free to reach out using the contact details below or the form provided.
  </p>
  ...
  <div className="grid md:grid-cols-2 gap-8 bg-white p-8 rounded-lg shadow-md">
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Mail className="text-[#008753]" />
        <p>NaijaHustlePlug@gmail.com</p>
      </div>
      <div className="flex items-center gap-4">
        <Phone className="text-[#008753]" />
        <p>+234 705 089 6180</p>
      </div>
      <div className="flex items-center gap-4">
        <MapPin className="text-[#008753]" />
        <p>Nigeria</p>
      </div>
    </div>
    ...
    <form className="space-y-6">
      <div>
        ...
        <input
          type="text"
          className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#008753]"
      ...
      <button
        type="submit"
        className="bg-[#008753] text-white px-6 py-2 rounded hover:bg-green-700 transition"
      >
        Send Message
      </button>
    </form>
